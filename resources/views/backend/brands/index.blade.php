            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <a href="{{ route('dashboard.brands.create') }}" class="btn btn-sm btn-danger pull-right">Add New</a>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
...
aaSorting: [[0, 'desc']],
                ...
                columns: [
                    {
                        ...
                        render: function (data, type, row) {
                            var brandEditUrl = "{{ route('dashboard.brands.edit', ':id') }}";

                            brandEditUrl = brandEditUrl.replace(':id', data);
                            return '<a href="' + brandEditUrl + '">#' + data + '</a>';
                        }
                    },
                    {
                        data: 'featured_image',
                    ...
                    },
                    {
                        data: 'name',
                        render: function (data, type, row) {
                            return '<a href="{{ url('/dashboard/brands') }}' + '/' + row.id + '/edit' + '">' + data + '</a>';
                        }
                    },
                    ...
                    {data: 'created_at', name: 'created_at'},
                    {
                        ...
                        orderable: false,
                        render: function (data, type, row) {
                            var tempEditUrl = "{{ route('dashboard.brands.edit', ':id') }}";
                            var tempDeleteUrl = "{{ route('dashboard.brands.destroy', ':id') }}";

                            //var tempViewUrl = "{{ url('/brand/') }}" + "/" + row.slug;
                ...
                ajax: '{{ route('dashboard.brands.json') }}'
            });
        });
    </script>
@endpush