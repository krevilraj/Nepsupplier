                    ...
                    <div class="box-body">
                        <table id="" class="table table-bordered table-striped datatable">
                            ...
                            <tr>
                                ...
                                <th>Application of product</th>

                                <th>Date</th>
                                <th class="sorting-false">Action</th>
                                <th style="width:200px">Refrence Link</th>
    ...
    <div class="box box-default">
        ...
        <div class="modal-body">
            ...
            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                <input type="email" name="email" id="email" class="form-control" placeholder="Email to:">
...
aaSorting: [[0, 'desc']],
  ...
  render: function (data, type, row) {
                    ...
                    {data: 'created_at', name: 'created_at'},
                    {
                        ...
                        orderable: false,
                        render: function (data, type, row) {
                            var tempDeleteUrl = "{{ route('dashboard.request.destroy', ':id') }}";
      ...
      orderable: false,
                ...
                ajax: '{{ route('dashboard.request.json') }}'
            });
        });
...
<script>
    $(document).on("click", ".btn-request", function (e) {
        ...
        $.ajax({
            ...
            data: { email: $('#email').val(),subject: $('#subject').val(),message: $('#message').val(),id: $('#id').val(),type: 'request'},
