            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <form id="contactForm" class="form-col" action="{{ route('contact.post') }}" method="POST">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="checkbox"
                                           onchange="document.getElementById('send').disabled = !this.checked"/> Check
                                    If
                                    You Are A Human
                                    <br>
    ...
    <script>
        ...
        */
        ...
        var mapMarkers = [{
            ...
            html: "<strong>{{getConfiguration('company_name')}}</strong><br>{{getConfiguration('site_address')}}",
            icon: {
