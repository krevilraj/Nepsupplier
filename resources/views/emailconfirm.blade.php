    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                <div class="panel-heading" style="color: #57BC90;background-color: #f2dede;border-color: #ebccd1;font-weight: 800;text-align: center">Your Email is successfully verified</div>
