...
class ProductController extends Controller
{
    ...
    public function store(ProductRequest $request)
    {
        ...
        $data2 = [
            ...
            'msg' => 'New Product Has Been Added On ' . getConfiguration('company_name'),
            'link' => URL::to('/'),
            'button-name' => 'GO',
...
//        $collection = ProductImage::where('path', $request->input('path'))->get(['id']);
        $collection = ProductImage::where('path', $path)->get();
        ...
        $this->deleteAllImage($path);
        ProductImage::destroy($collection[0]->id);
        return response()->json([
            'success' => true,
